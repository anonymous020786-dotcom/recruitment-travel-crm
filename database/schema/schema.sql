...
-- CMS pages (migration 0023): pages, their revisions and shareable preview links.
...
-- CMS extras (migration 0024): redirects, snippets, menus.
...
-- CMS media library (migration 0025).
...
-- Online payments through a gateway (migration 0020).
