...
-- Generated from database/schema/schema.sql. Portable across MySQL 8+ and MariaDB 10.4+.
-- The migration runner splits on ";" at end-of-line; this baseline contains no
-- stored routines/triggers so that is safe.
