...
<div class="grid gap-6 lg:grid-cols-2">
    ...
    <?php if ($editing): ?>
        <section class="card card-body" aria-labelledby="preview-h">
            ...
            <div class="space-y-3 text-sm leading-relaxed text-slate-800 [&_a]:text-brand-600 [&_a]:font-medium [&_h3]:mt-4 [&_h3]:text-lg [&_h3]:font-semibold [&_h4]:mt-3 [&_h4]:font-semibold [&_ol]:list-decimal [&_ol]:pl-6 [&_ul]:list-disc [&_ul]:pl-6">
